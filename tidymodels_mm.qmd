...
```{r assess_wait_i_last_spline_res}
# Grab the predictions on the test data
...
couldn't quite get it to work even after digging into the source code and finding
